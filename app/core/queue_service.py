...
class SingerEventPublisher:
    ...
    async def publish_singer_changed(cls, venue_id: str, singer: Singer, event_type: str = "singer_changed") -> None:
        ...
        payload = {
            ...
            "name": str(singer.stage_name) if singer.stage_name else None,
            "display_name": str(singer.stage_name) if singer.stage_name else None,
            "first_name": str(singer.first_name) if singer.first_name else None,
            "last_name": str(singer.last_name) if singer.last_name else None,
