...
from app.routers import (
    venues, songs, singers, singer_favorites, singer_follows, queue_singer, queue,
    queue_admin, loyalty, commerce, social, analytics, auth, kj_auth, kj_sync,
    payments, notifications, admin, onboarding, admin_venues, billing, accounts,
    repair_sync, license, admin_license, download_analytics,
)
...
api_router.include_router(repair_sync.router, prefix="/kj/sync", tags=["Repair Sync"])

api_router.include_router(admin.router, prefix="/admin", tags=["Admin"])
api_router.include_router(admin_venues.router, prefix="/admin", tags=["Admin Venues"])
api_router.include_router(admin_license.router, prefix="/admin", tags=["Admin Licenses"])
